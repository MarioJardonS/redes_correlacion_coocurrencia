...
```
```{r}
rizosfera_chile <- import_biom("./chile.txt_9.biom") #, row.names = 1, header = TRUE , sep = "" )
...
data <- read.table("./redes_correlacion_coocurrencia/data/tables/table.from_chile.txt" , row.names = 1, header = TRUE , sep = "" )
...
metadata <- paste0("./redes_correlacion_coocurrencia/data/metadata/metadata_chile.csv")
...
red <- read.csv("./redes_correlacion_coocurrencia/data/networks/chile_species_raw_network.csv")
...
```{r}
otus_centrales <- read.csv("./results/reporte_chile1" , row.names = 1)
otus_centrales
