...
for (i in 1:dim(phy_chile@otu_table@.Data)[2]){
  ...
  print(mean(as.vector(phy_chile@otu_table@.Data[, i])))
  means <- c(means , mean(phy_chile@otu_table@.Data[, i]))
  }
...
for (i in 1:dim(phy_tomate@otu_table@.Data)[2]){
  ...
  print(mean(as.vector(phy_tomate@otu_table@.Data[, i])))
  means <- c(means , mean(phy_tomate@otu_table@.Data[, i]))
  }
