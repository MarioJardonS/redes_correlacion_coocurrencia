...
%figuras de phylum des_vs_no_des
\begin{figure}
\centering
...
\begin{figure}
    \centering
    \includegraphics[scale = 0.8]{phyla_key_tomate.png}
    \caption{Relative abundance by phyla of keystone OTUs in rhizosphere samples of \textit{Solanum lycopersicum}.}
    \label{fig:tomate_key_abundance_phyla}
\end{figure}

%figuras de familia des_vs_no_des
\begin{figure}
\centering
...
\begin{figure}
    \centering
    \includegraphics[scale = 0.8]{family_key_tomate.png}
    \caption{Relative abundance by families of keystone OTUs in rhizosphere samples of \textit{Solanum lycopersicum}. Less abundant families are those whose abundance is less than the median abundance of families of keystone OTUs}
    \label{tomate_key_abundance_families}
\end{figure}

%figuras de género des_vs_no_des
\begin{figure}
\centering
