...
dred_tomate <- read.csv("../../data/networks/tomate_species_raw_network.csv")
...
En la red de los OTUs centrales de rizósfera de chile el virus Spodoptera exigua multiple nucleopolyhedrovirus es el único nodo de grado 1.
...
red_otus_no_centrales_chile <- induced_subgraph(redes[[2]] , otus_no_centrales_tomate , "auto" )
