...
return( list(  data[ filt , ] , data[filt_0 ,] ))
}
...
rizosferas <- c( rizosfera_chile , rizosfera_tomate , rizosfera_maiz )
...
```{r}
metadata_chile <- read.csv("../../data/metadata/metadata_chile.csv")
metadata_tomate <- read.csv("../../data/metadata/metadata_tomate.csv")
metadata_maiz <- read.csv("../../data/metadata/metadata_maiz.csv")
