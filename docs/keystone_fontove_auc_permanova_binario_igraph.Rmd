...
```
##Funciones para área bajo la curva y proporción de área bajo la curva
...
##Función para estadístico pseudo-F, para comparar entre medidas por grupos
...
##Candidatos para especie clave según las medidas de centralidad
