...
En la siguiente celda se crean la lista grupos cuyas entradas serán vectores que se correspondan a las muestras pertenecientes a cada grupo presente en los metadatos.
